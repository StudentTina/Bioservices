...
import os
os.makedirs('C:\\Users\\Tina\\Documents\\NYU_PYTHON_CLASS_SPRING_2018_BI_GY_7663\\Bioservices\\DrugIDs',exist_ok=True)
path = 'C:\\Users\\Tina\\Documents\\NYU_PYTHON_CLASS_SPRING_2018_BI_GY_7663\\Bioservices\\DrugIDs'
...
file2 = open("C:\\Users\\Tina\\Documents\\NYU_PYTHON_CLASS_SPRING_2018_BI_GY_7663\\Bioservices\\Report.txt", "w")
...
for x in unique_drug_ids:
    with open(os.path.join(path,x+".txt"),'r') as file3: # This loop allows us to read each new drug ID file
        ...
        Pathways = re.findall('^(  PATHWAY)   (.*)$', f.read(), flags=re.M) #using re I pull for the lines that match PATHWAY, which will give us the pathways the drug targets
